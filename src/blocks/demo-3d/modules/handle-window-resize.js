...
export default function handleWindowResize(camera, renderer, object3D) {
  const width = object3D.parentContainer.clientWidth;
  const height = object3D.parentContainer.clientHeight;
